...
#
# Implements a class to use the SAPI.SpVoice API. Also implements the 
# standalone server and the dcs udp server, to map the profiles based
# on plane.
#
# see here https://blog.thea.codes/talking-to-gamepads-without-pygame/ to
# learn about reading joystick input without pygame.
#
# ############################################################################
